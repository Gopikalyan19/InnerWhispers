...
function populateInvoice() {
    ...
    const invoiceData = {
        items: [
            { description: "Antidepressant A",descriptions: "20mg, twice a day", quantity: 1, unitPrice: 10.00 },
            { description: "Anti-Anxiety B",descriptions: "10mg, once a day", quantity: 1, unitPrice: 20.00 },
            { description: "Sleep Aid C",descriptions: "5mg, once a night", quantity: 1, unitPrice: 20.00 },
    ...
    invoiceData.items.forEach(item => {
        ...
        const row = `<tr>
              ...
              <td><input type="text" class="description cmn-input" value="${item.descriptions}"></td>
